...
| ID-09 | Importazione ed esportazione delle note, per non tenere i dati "chiusi" nell'app | Claude (dal problema descritto in visione) | 24/09/2026 | Accettata | RF-13 | Diventa RF-13, priorità Should |
| ID-10 | Gestione dei conflitti di sincronizzazione senza perdita di testo (copia di conflitto, scelta dell'utente o unione automatica) | Manuel Cucca | 24/09/2026 | Accettata | RF-10 | Si salvano entrambe le versioni in conflitto (DEC-06, che supera DEC-03) |
